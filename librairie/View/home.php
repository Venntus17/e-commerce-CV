<div id="home">
    <div id="present">
        <div id="perso">
            <p>
                Je suis un étudiant en recherche d'une alternance pour mon BTS SIO SLAM pour 2021-2022 et 2022-2023, ce site ne sert que de CV sous forme de site e-commerce.
                Les produits sont gratuits (Mes projets/Compétences).
            </p>
        </div>
        <div id="carousel">
            <div class="gallery">
